...
# However, there are problems with time-based candles.
## しかし、時間ベースのローソク足ーには問題があります。
...
## For tick bars, I sampled about 50,000 tick-based bars, with a threshold of 8000 transactions.
