...
# According to the Lopez de Prado, time bars should be avoided because:
## 著者によると、タイムバーは避けるべき理由は：
...
# There is another source of tick data.
## ティックデータの別のソースがあります。
...
# Over a 1000 day period, Bitmex average daily volume was approximately $181,000,000.
## 1000日間の1日の平均ボリュームは約181,000,000ドルでした。
...
<img width="50%" src={timeAuto} />

---

<img width="50%" src={tickAuto} />

---

<img width="50%" src={volumeAuto} />
...
<img width="60%" src={partialNormality} />
...
<img width="55%" src={oct26Time} />

#### Time, 4 bars

---

<img width="55%" src={oct26Tick} />

#### Tick, 42 bars

---

<img width="55%" src={oct26Volume} />
